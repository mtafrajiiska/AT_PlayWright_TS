...
addBorderBtn.addEventListener("click", function (event) {
...
var contentSection2 = document.querySelector(".content");
...
var changeTextBtn2 = document.getElementById("change-text-btn");
var contentSection3 = document.querySelector(".content");
changeTextBtn2.addEventListener("click", function (event) {
...
var contentSection4 = document.querySelector(".content");
contentSection4.addEventListener("mouseover", function () {
